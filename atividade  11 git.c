...
int main() {
    ...
    while ((opcao != 1) && (opcao != 2) && (opcao != 3)) {
        ...
        if (opcao == 1) {
            ...
            printf("A media total do primeiro aluno é: %f \n", media1);
            if (media1 < 4) {
                printf("Reprovado\n");
            } else if (media1 < 6) {
                printf("Recuperacao\n");
            ...
            printf("A media total do terceiro aluno é: %f \n", media3);
            if (media3 < 4) {
                printf("Reprovado\n");
            } else if (media3 < 6) {
                printf("Recuperacao\n");
            ...
            printf("A media total do quarto aluno é: %f \n", media4);
            if (media4 < 4) {
                printf("Reprovado\n");
            } else if (media4 < 6) {
                printf("Recuperacao\n");
            ...
            printf("A media total do quinto aluno é: %f \n", media5);
            if (media5 < 4) {
                printf("Reprovado\n");
            } else if (media5 < 6) {
                printf("Recuperacao\n");
